...
export default function ConnectionErrorView({darkMode, appName, url, handleLink, errorInfo}: Props) {
    const header = (
        <FormattedMessage
            ...
            defaultMessage='Could not connect to this project'
        />
    );
    ...
    const subHeader = (
        <>
            <FormattedMessage
                ...
                defaultMessage={'We\'re having trouble connecting to this {appName} project. We\'ll keep trying to establish a connection.'}
                values={{
                    appName,
                }}
            />
        ...
        <>
            ...
            <li>
                <FormattedMessage
                    ...
                    defaultMessage='Verify that the {appName} URL <link>{url}</link> is correct.'
                    values={{
                        appName,
                        url,
    ...
    const contactAdmin = (
        <FormattedMessage
            ...
            defaultMessage='If the issue persists, please contact your administrator'
        />
    );
