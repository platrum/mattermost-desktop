...
describe('main/menus/app', () => {
    ...
    it('should show `Sign in to another project` if `enableServerManagement` is true', () => {
        localizeMessage.mockImplementation((id) => {
            switch (id) {
            case 'main.menus.app.file':
                return '&File';
            case 'main.menus.app.file.signInToAnotherServer':
                return 'Sign in to another project';
            default:
                return id;
            }
        });
        ...
        const signInOption = fileMenu.submenu.find((item) => item.label === 'Sign in to another project');
        expect(signInOption).not.toBe(undefined);
    });

    it('should not show `Sign in to another project` if `enableServerManagement` is false', () => {
        localizeMessage.mockImplementation((id) => {
            switch (id) {
            case 'main.menus.app.file':
                return '&File';
    ...
    it('should not show `Sign in to another project` if no servers are configured', () => {
        localizeMessage.mockImplementation((id) => {
            switch (id) {
            case 'main.menus.app.file':
                return '&File';
